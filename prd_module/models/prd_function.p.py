...
class PrdFunction(models.Model):
    ...
    models_src = fields.Text(string="Models source")
    ...
    data_xml = fields.Text(string="XML Data")
...
"""
    ...
    replace_content = fields.Boolean(
        string="Replace content", help="replace code or add to the bottom"
    )
    ...
    content_views = fields.Text(
        string="Content Views", related="views_file_id.content", readonly=False
    )
    ...
    views_replace = fields.Boolean(
        string="Replace views", help="replace code or add to the bottom"
    )
