...
class PrdFunction(models.Model):
    ...
    tests_file_id = fields.Many2one(comodel_name='prd.odoo_module.file',string="Tests", help="", ) 
    data_file_id = fields.Many2one(comodel_name='prd.odoo_module.file',string="Data", help="", ) 
    ...
    content_views = fields.Text(string='Views',related="views_file_id.content",readonly=False) 
    views_file_id = fields.Many2one(comodel_name='prd.odoo_module.file',string="Views", help="", ) 
