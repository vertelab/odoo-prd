...
MODULEFIELDS = [
    'application', 'author', 'auto_install', 'category_id', 'contributors',
    'description', 'description_html', 'icon', 'icon_flag', 'icon_image',
    'license', 'maintainer', 'name','shortdesc', 'summary', 'website'
]
